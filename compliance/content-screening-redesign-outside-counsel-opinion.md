...
1. **CCPA-coverage question (Q4) — resolved 2026-09-05.** Peter consulted with counsel directly: Rincon is not a CCPA-covered business. Per counsel's own branching logic above, this means the CPPA's 2026 risk-assessment regulations do not apply to this redesign (or, on the same reasoning, to Rincon's other processing generally, independent of this specific feature) — no formal statutory risk assessment is required on CCPA grounds. This does not change counsel's separate recommendation of a short, non-mandatory internal management risk memo as good governance practice (see Section 9 of `content-screening-tier-redesign-SPEC.md`) — that recommendation was never contingent on CCPA coverage.
