/**
 * views/layout.js
 * Plain string-template HTML layout — no templating engine dependency
 * needed for something this simple. Shared header/nav/footer + basic CSS.
 * Mobile-first: single column, big tap targets, readable at 375px wide.
 */
...
${user ? `<header class="topbar">
  <div class="brand">Rincon Content Review</div>
  <nav>
    <a href="/">Drafts</a>
    <a href="/topics">Topic Suggestions</a>
    <a href="/legal-updates">Legal Updates</a>
    <a href="/ideas/new">Submit an Idea</a>
    <a href="/social/new">New Social Post</a>
    <a href="/social/batches">Social Batches</a>
