...
- **Resolved (2026-09-05): whether Rincon qualifies as a covered CCPA business.** Peter consulted with counsel directly — Rincon is not a CCPA-covered business, resolving counsel's own open question (Section 5). No CPPA-administered risk-assessment or ADMT requirement applies to this processing on that basis.
